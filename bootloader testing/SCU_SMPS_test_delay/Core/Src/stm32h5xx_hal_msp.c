...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI2_MspDeInit 0 */
    ...
    PB15     ------> SPI2_MOSI
    */
    HAL_GPIO_DeInit(GPIOB, SCKL_2_Pin|MISO_2_Pin|MOSI_2_Pin);
  ...
  /* USER CODE END SPI3_MspDeInit 0 */
    ...
    PC12     ------> SPI3_MOSI
    */
    HAL_GPIO_DeInit(GPIOC, SCKL_3_Pin|MISO_3_Pin|MOSI_3_Pin);
  ...
  /* USER CODE END SPI5_MspDeInit 0 */
    ...
    PF9     ------> SPI5_MOSI
    */
    HAL_GPIO_DeInit(GPIOF, SCKL_1_Pin|MISO_1_Pin|MOSI_1_Pin);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END UART4_MspDeInit 0 */
    ...
    PB9     ------> UART4_TX
    */
    HAL_GPIO_DeInit(GPIOB, UART_RX2_Pin|UART_TX2_Pin);
  ...
  /* USER CODE END UART5_MspDeInit 0 */
    ...
    PB6     ------> UART5_TX
    */
    HAL_GPIO_DeInit(GPIOB, UART_RX3_Pin|UART_TX3_Pin);
  ...
  /* USER CODE END UART8_MspDeInit 0 */
    ...
    PE1     ------> UART8_TX
    */
    HAL_GPIO_DeInit(GPIOE, UART_RX1_Pin|UART_TX1_Pin);
  ...
  /* USER CODE END USART10_MspDeInit 0 */
    ...
    PE3     ------> USART10_TX
    */
    HAL_GPIO_DeInit(GPIOE, UART_RX4_Pin|UART_TX4_Pin);
