...
void Erase_SRAM(SRAM_HandleTypeDef *hsram1) {
    ...
    // Call the HAL function to erase SRAM by writing 0x00 to all locations
...
//		{
//			nand_buf[nand_index++] = rcv ;
//			if(nand_buf[nand_index-1]=='$')
//			{
//				memcpy(NandGuiBuf,nand_buf,nand_index);
//				ATP_test  = 1;
//				nand_index = 0;
//				nand_flag = 0;
//			}
