...
#define page_addr 			((uint32_t *)(0x60000000))
#define block_addr 			((uint32_t *)(0x60000002))
#define plane_addr 			((uint32_t *)(0x60000004))

#define sram_baseaddr 	    ((uint32_t *)(0x60000000))
#define century 			((uint32_t *)((uintptr_t)sram_baseaddr | 0x7FFF8))
#define sec_addr 			((uint32_t *)((uintptr_t)sram_baseaddr | 0x7FFF9))
#define min_addr 			((uint32_t *)((uintptr_t)sram_baseaddr | 0x7FFFa))
#define hr_addr 			((uint32_t *)((uintptr_t)sram_baseaddr | 0x7FFFb))
#define day_addr 			((uint32_t *)((uintptr_t)sram_baseaddr | 0x7FFFc))
#define date_addr 			((uint32_t *)((uintptr_t)sram_baseaddr | 0x7FFFd))
#define month_addr 			((uint32_t *)((uintptr_t)sram_baseaddr | 0x7FFFe))
#define year_addr 			((uint32_t *)((uintptr_t)sram_baseaddr | 0x7FFFf))


extern SRAM_HandleTypeDef hsram1;
extern UART_HandleTypeDef huart5;
extern _sNandOperation Nandopt;
...
//uint32_t century = 0x60000000| 0x7FFF8;
