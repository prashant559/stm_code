...
extern _sADCmodule ADCmodule_1;
extern _sADCmodule ADCmodule_2;
extern _sADCmodule ADCmodule_3;
extern _sADCpacket ADCpacket;
extern _sSRAMOperation SRAMopt;
extern uint8_t ATP_test;
extern uint8_t ATP_Mode;
...
uint16_t Hex_data_ADC_1=0;
uint16_t Hex_data_ADC_2=0;
uint16_t Hex_data_ADC_3=0;
uint16_t Hex_data_ADC_4=0;
uint8_t res;
